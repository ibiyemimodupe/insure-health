    ...
    return(
        <div className="policy-cont">
            <div className="logo1"><img onClick={backToHome} src={logo} alt="logo" width='100%' /></div>
             ...
             <p className="p">As a user of InsureHealth website and services, you agree to follow this user rules.</p>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <ol className="policy-list">
                            ...
                            <li>You agree not to post any copyrighted material unless the copyright is owned by you or on  InsureHealth.</li>
                            <li>Disclosure of someone's personal data, or invasion of privacy, is strictly forbidden. Examples could include but are not limited to, personal names, private addresses, phone numbers, social security numbers, private email addresses, registration numbers of vehicles, ethnicity, health status, political and religious beliefs, sexual orientation, personal finance, occupation, law violations, criminal convictions or arrests, etc.</li>
                            <li>If you spam our members in any manner, your account will be inactivated or banned. Do not contact anyone, to suggest your product or service, who is not explicitly expecting you to contact them.</li>
                            <li>We take the "Be Polite" rule very seriously! We do not tolerate any rudeness. Any member who is intentionally unpleasant or disruptive may be banned without warning.</li>
                            <li>Any abuse towards our staff and/or management in any form may result in immediate suspension of your account.</li>
                            <li>Any user who feels that a posted message is objectionable is encouraged to contact us immediately by email. We can remove objectionable messages and we will make every effort to do so, within a reasonable time frame, if we determine that removal is necessary.</li>
                    ...
                    <li>
                        <h3>Rules for user reviews on products</h3>
                        <p>Opinions should be specific and based on facts. They should reflect the consumer's own experiences regarding product functionality, performance, quality, content, etc.</p> <br />
                    </li>

                    <li>
                        <h3>Updates to these rules and guidelines</h3>
