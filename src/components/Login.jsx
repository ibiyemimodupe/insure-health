  ...
  return (
    <div className="login-page">
              ...
              <ul className="footer-list">
                <li>
                  <a href="/">
                    <FontAwesomeIcon
                      icon={faAppleWhole}
                      style={{ width: 50, color: "#891180", height: 50 }}
                    />
                  </a>
                </li>
              </ul>
        ...
        <div className="acc-cont">
          <p>
            ...
            <Link to="/signup" style={{ textDecoration: "none" }}>
              <span className="acc">Sign up</span>
            </Link>{" "}
          </p>
        </div>
      </div>
      ...
      <div className="frame-cont">
        ...
        <h2>
          Check out our network <br /> of health providers{" "}
        </h2>
        <p>
          Enjoy the flexibility that comes with this <br /> platform
        </p>
      </div>
    </div>
  );
