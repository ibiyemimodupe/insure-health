        ...
        <div className="hero-cont">
            <div className="hero-text">
                <div className="hero">
                    ...
                    <p>Insur Health is your one stop for all things Healthcare,We are concerned with providing Health assistance for all, regardless of their budget or income. We currently provide HMO’s assistance to Low and high income earners and individuals across Nigeria.</p>
                    <br />
                    <p>
                ...
                <div className="hero-img-cont">
                    <div className="try">
                        <div className='cone-img'>
                            <img src={pic1} alt="image of a doctor" width='50%' />
                        ...
                        <div className='cone-img'>
                            <img src={pic2} alt="image of a doctor" width='50%' />
                    ...
                    <div className="trys">
                        <div className='cone-img'>
                            <p>Since we are a company that’s bent on providing solutions to accessible healthcare we ensure feedback is generated from our clients whenever they use any HMO we offer. Feedback is important to us.</p>
                            <img src={pic3} alt="image of a doctor" width='50%' />
                        </div>
                        <div className='cone-img'>
                            ...
                            <img src={pic4} alt="image of a doctor" width='50%' />
                        </div>
                    </div>
                </div>
            </div>
